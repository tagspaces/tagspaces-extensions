...
const App: React.FC = () => {
  ...
  const milkdownListener = React.useCallback((markdown: string, prevMarkdown: string | null) => {
  ...
  const onCodeChange = React.useCallback((code: string, prevCode: string | null) => {
    updateContent(code, prevCode);
